...
: ${AMENT_CURRENT_PREFIX:="/root/colcon_ws/install/isaac_diffbot_sim"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/isaac_diffbot_sim/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/isaac_diffbot_sim/environment/path.sh"
